...
export default function ServiceAreas() {
  return (
    <section id="areas" className="w-full bg-[#f2fbf7]">
        ...
        >
          {NEIGHBOURHOODS.map((area) => (
            <RevealItem
              as="li"
              key={area}
              className="rounded-full border border-[#e3eae7] bg-white px-4.5 py-2 text-xs font-semibold text-ink/80 transition-all hover:border-primary/45 hover:bg-[#f2fbf7] hover:text-primary-d"
            >
              {area}
            </RevealItem>
          ))}
